const projectsData = [
    {
        ...
        completed: false,
        bannerImage: 'data/res/projects/banner-space-invaders.jpg',
    ...
    },
    {
        ...
        completed: false,
        bannerImage: 'data/res/projects/banner-portfolio-website.png',
    ...
    },
    {
        ...
        completed: true,
        bannerImage: 'data/res/projects/banner-pixel-conquest.png',
        category: ['High-Level'],
        links: [
    ...
    },
    {
        ...
        completed: true,
        bannerImage: 'data/res/projects/banner-grids.png',
        category: ['High-Level'],
        links: [
            { web: 'https://github.com/Jordieboyz', icon: 'github' },
        ],
    },
    {
        ...
        completed: false,
        bannerImage: 'data/res/projects/truenas.png',
    ...
    },
    {
        ...
        completed: true,
        bannerImage: 'data/res/projects/banner-sfos-fp4.png',
        category: ['Low-Level'],
        links: [
            { web: 'https://github.com/Jordieboyz', icon: 'github' },
            { web: '#', icon: 'globe' },
    ...
    },
    {
        ...
        completed: true,
        bannerImage: 'data/res/projects/banner-symbolic.png',
        category: ['Mid-Level'],
        links: [
            { web: 'https://github.com/Jordieboyz', icon: 'github' },
        ],
    },
    {
        ...
        completed: true,
        bannerImage: 'data/res/projects/banner-hotline.png',
        category: ['High-Level'],
        links: [
            { web: 'https://github.com/Jordieboyz', icon: 'Github' },
        ],
    },
    {
        ...
        completed: true,
        bannerImage: 'data/res/projects/banner-gomoku.png',
        category: ['Mid-Level'],
        links: [
            { web: 'https://github.com/Jordieboyz', icon: 'github' },
        ],
    },
    {
        ...
        completed: true,
        bannerImage: 'data/res/projects/banner-nrf-arduino.png',
        category: ['Low-Level'],
        links: [
            { web: 'https://github.com/Jordieboyz', icon: 'Github' },
        ],
